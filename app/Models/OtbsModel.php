...
class OtbsModel extends Model
{
  ...
  public function InsertOtb($userId,$data)
  {
    $userModel=new UsersModel();
      ...
      $otbId=$this->insert(["Name" => $data["Name"]]); //Insertamos el nombre de la nueva OTB en BDD
      $userModel->update($userId,[
        "Otb_ID"=>$otbId,
        "Type"=>1]); //Actualizamos al usuario para desiganarle su ID de OTB y su Tipo para que sea Admin de esa OTB
